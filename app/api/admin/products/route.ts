  ...
  try {
    ...
    if (error) {
      return NextResponse.json(
        { ok: false, error: "No se pudieron cargar los productos", detail: error.message },
        { status: 500 }
      );
    }
    ...
    return NextResponse.json(
      { ok: false, error: "No se pudieron cargar los productos", detail },
      { status: 500 }
    );
  }
}
...
export async function POST(req: Request) {
  try {
    ...
    if (error) {
      return NextResponse.json(
        { ok: false, error: "No se pudo crear el producto", detail: error.message },
        { status: 500 }
      );
    }
    ...
    return NextResponse.json(
      { ok: false, error: "No se pudo crear el producto", detail },
      { status: 500 }
    );
  }
}
...
export async function PATCH(req: Request) {
  try {
    ...
    if (error) {
      return NextResponse.json(
        { ok: false, error: "No se pudo actualizar el producto", detail: error.message },
        { status: 500 }
      );
    }
    ...
    return NextResponse.json(
      { ok: false, error: "No se pudo actualizar el producto", detail },
      { status: 500 }
    );
  }
}
...
export async function DELETE(req: Request) {
  try {
    ...
    if (error) {
      return NextResponse.json(
        { ok: false, error: "No se pudo eliminar el producto", detail: error.message },
        { status: 500 }
      );
    }
    ...
    return NextResponse.json(
      { ok: false, error: "No se pudo eliminar el producto", detail },
      { status: 500 }
    );
  }
}
